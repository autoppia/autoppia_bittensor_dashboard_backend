...
def _round_payload(validator_round_id: str, validator_uid: int) -> dict:
    return {
...
def test_progressive_round_flow(client):
    ...
    validator_round_id = "round-42"
    validator_uid = 77
    miner_uid = 101

    start_payload = _round_payload(validator_round_id, validator_uid)
