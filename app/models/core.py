...
class MinerInfo(BaseModel):
    ...
    description: Optional[str] = Field(default=None, description="Optional description for the agent")
    provider: Optional[str] = Field(default=None, description="Company or provider for the agent")
...
class Round(BaseModel):
    ...
    sota_agents: List[MinerInfo] = Field(default_factory=list, description="Benchmark agents evaluated alongside miners")
...
class AgentEvaluationRun(BaseModel):
    ...
    task_ids: List[str] = Field(default_factory=list, description="Tasks executed during the run")
