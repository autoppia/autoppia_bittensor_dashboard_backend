        ...
        try:
            ...
            for validator_uid, data in list(validator_data.items())[:6]:
                ...
                validator_cards.append({
                    ...
                    "logo_url": f"/logos/validator_{validator_info['validator_uid']}.png",
        ...
        try:
            ...
            result = {
                ...
                "validator_info": {
                    ...
                    "validator_image": f"/logos/validator_{agent_run['validator_info']['validator_uid']}.png",
                    "version": "v7.2.1",
                    "status": "Running",
                    "stake": 1722000,
                    "stake_display": "1722K",
                ...
                "miner_info": {
                    ...
                    "miner_image": f"/logos/miner_{agent_run['miner_info']['miner_uid']}.png",
                    "rank": agent_run["rank"],
                    "status": "active"
                },
                "overall_metrics": {
        ...
        try:
            ...
            result = {
                ...
                "validator_info": {
                    ...
                    "validator_image": f"/logos/validator_{task_execution['validator_info']['validator_uid']}.png",
                    "version": "v7.2.1",
                    "status": "Running",
                    "stake": 1722000,
                    "stake_display": "1722K",
