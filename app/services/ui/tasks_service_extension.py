...
async def get_tasks_with_solutions(
    ...
    if website:
        ...
        # Join with TaskORM to filter by start_url
        ...
        filters.append(func.lower(TaskORM.start_url).like(f"%{website_lower}%"))
    ...
    if use_case:
        ...
        filters.append(func.lower(TaskORM.use_case) == use_case.lower())
    ...
    for eval_result in evaluation_results:
        ...
        # Extract website from start_url
        website_name = _map_website_port_to_name(task_orm.start_url)
        
        task_data = {
            "taskId": task_orm.task_id,
            "website": website_name,
            "useCase": task_orm.use_case or "unknown",
            "intent": task_orm.intent or "",
            "startUrl": task_orm.start_url or "",
            "requiredUrl": task_orm.required_url,
