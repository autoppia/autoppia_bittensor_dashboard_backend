...
async def list_tasks(
    ...
    minerUid: Optional[int] = Query(None),
...
async def search_tasks(
    ...
    minScore: Optional[float] = Query(None),
    maxScore: Optional[float] = Query(None),
    successOnly: Optional[bool] = Query(None, description="Filter to tasks with reward > 0 (success)"),
    successMode: Optional[str] = Query(None, description="all | successful | non_successful"),
    season: Optional[int] = Query(None, description="Filter evaluations by season number"),
    round: Optional[int] = Query(None, description="Filter evaluations by round number within season"),
    startDate: Optional[datetime] = Query(None),
    endDate: Optional[datetime] = Query(None),
    sortBy: str = Query("startTime"),
    sortOrder: str = Query("desc"),
