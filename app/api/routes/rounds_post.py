...
async def submit_round_data(payload: RoundSubmissionRequest):
    ...
    try:
        logger.info(f"Starting round submission for round {payload.round.round_id}")
        ...
        logger.info(f"Saved round {round_data.round_id}")
        ...
        for task_solution in payload.task_solutions:
            ...
            task_solution_doc["round_id"] = round_data.round_id
        ...
        for eval_result in payload.evaluation_results:
            ...
            eval_result_doc["round_id"] = round_data.round_id
        ...
        response = RoundSubmissionResponse(
            success=True,
            message=f"Successfully submitted round {round_data.round_id}",
            round_id=round_data.round_id,
        ...
        logger.info(f"Round submission completed in {processing_time:.3f}s for round {round_data.round_id}")
        return response
