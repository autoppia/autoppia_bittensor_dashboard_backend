...
async def test_start_round_season_1_round_1_with_tasks(client, monkeypatch, db_session):
    ...
    try:
        ...
        stmt = select(ValidatorRoundORM).where(ValidatorRoundORM.validator_round_id == validator_round_id)
        ...
        stmt = select(TaskORM).where(TaskORM.validator_round_id == validator_round_id)
        ...
        stmt = select(ValidatorRoundMinerORM).where(ValidatorRoundMinerORM.validator_round_id == validator_round_id)
